...
public enum IssueEventType {
    ...
    @Json(name = "blocked_by_added") BlockedByAdded,
    @Json(name = "blocked_by_removed") BlockedByRemoved,
    @Json(name = "blocking_added") BlockingAdded,
    @Json(name = "blocking_removed") BlockingRemoved,
    ...
    @Json(name = "issue_type_added") IssueTypeAdded,
    @Json(name = "issue_type_changed") IssueTypeChanged,
    @Json(name = "issue_type_removed") IssueTypeRemoved,
    ...
    @Json(name = "parent_issue_added") ParentIssueAdded,
    @Json(name = "parent_issue_removed") ParentIssueRemoved,
    ...
    @Json(name = "sub_issue_added") SubIssueAdded,
    @Json(name = "sub_issue_removed") SubIssueRemoved,
